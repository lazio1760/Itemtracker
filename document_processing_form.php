...
/*
$content .= "<table><tbody>";
$content .= "<tr><td class=\"tdWidth\"><label class=\"highlight\"> FDA Application Number </label></td>";
$content .= "<td><input type=\"text\" id=\"fdaAppNumber\" name=\"fdaAppNumber\"/></td></tr>";
$content .= "</tbody></table>";
*/
...
$content .= "<tr><td class=\"tdWidth\"><label class=\"highlight\"> Receipt Date </label></td><td><input type=\"text\" id=\"receiptDate\" name=\"receiptDate\" class=\"datepicker\" /></td></tr>";
$content .= "</tbody></table>";
$content .= "</form>";
